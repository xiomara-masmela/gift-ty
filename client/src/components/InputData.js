...
import { FormLabel, FormControlLabel, Checkbox, FormControl, Container, TextField, FormGroup, Button} from '@mui/material';
...
export function InputData(){
   ...
   function handleSubmit(event){
       ...
       console.log(age, colour, likes)
       setInputs({"age": age, "colour": colour, "event": "event", "likes": likes});
       console.log(inputs);
    ...
    return (
        <Container maxWidth="sm">
            <FormControl fullWidth >
                <TextField id="outlined-basic" label="Age" variant="outlined" value={age} onChange={handleAgeChange}/>
                <TextField id="outlined-basic" label="colour" variant="outlined" value={colour} onChange={handleColourChange} />
